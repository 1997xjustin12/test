export default async function handler(req, res) {
  ...
  try {
    const url = `${process.env.NEXT_SOLANA_BACKEND_URL}/api/subscribers/unsubscribe/`;
    ...
    if (!contentType || !contentType.includes("application/json")) {
      ...
      console.error("subscribers/unsubscribe: upstream returned a non-JSON response:", text.slice(0, 500));
      return res
        .status(500)
