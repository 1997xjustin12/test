...
const GrillProtectionSection = () => {
  return (<div className="w-full flex bg-slate-50 border border-slate-200">
      ...
      <div className="flex mt-4">
        ...
        <div className="w-full pl-4 flex flex-col gap-[25px]">
          ...
          <div className="text-sm">
            <Link href="#" prefetch={false} className="flex gap-[8px] underline">
              <div>See Plan Details</div>
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><path fill="currentColor" d="M14 3v2h3.59l-9.83 9.83l1.41 1.41L19 6.41V10h2V3m-2 16H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7h-2z"/></svg>
            </Link>
          </div>
