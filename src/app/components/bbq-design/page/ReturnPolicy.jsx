...
export default function BBQReturnPolicyPage() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2">
          <PolicySection title="Return Eligibility">
            <p>
              You have{" "}
              <span className="font-semibold underline">30 calendar days</span>{" "}
            ...
            <p>
              ...
              <strong className="text-char dark:text-ash">20%</strong> is
          ...
          <PolicySection title="Items That Do Not Qualify for Returns">
            <ul className="list-none space-y-2">
              {[
                ...
                <li key={item} className="flex items-start gap-2 text-ember">
