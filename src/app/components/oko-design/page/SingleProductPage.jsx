...
import Breadcrumb from "@/app/components/oko-design/sections/sp/Breadcrumb";
import Topbar from "@/app/components/oko-design/sections/sp/Topbar";
import ImageGallery from "@/app/components/oko-design/sections/sp/ImageGallery";
import ProductInfo from "@/app/components/oko-design/sections/sp/ProductInfo";
import CompareTable from "@/app/components/oko-design/sections/sp/CompareTable";
import FrequentlyBoughtTogether from "@/app/components/oko-design/sections/sp/FrequentlyBoughtTogether";
import StickyCTA from "@/app/components/oko-design/sections/sp/StickyCTA";
import MobileStickyCTA from "@/app/components/oko-design/sections/sp/MobileStickyCTA";
...
const CollectionStrip = dynamic(
  () => import("@/app/components/oko-design/sections/sp/CollectionStrip"),
  { loading: () => null },
);
const DescriptionSection = dynamic(
  () => import("@/app/components/oko-design/sections/sp/DescriptionSection"),
  { loading: () => null },
);
const SpecsShipping = dynamic(
  () => import("@/app/components/oko-design/sections/sp/SpecsShipping"),
  { loading: () => null },
);
const ReviewsSection = dynamic(
  () => import("@/app/components/oko-design/sections/sp/ReviewsSection"),
  { loading: () => null },
);
const FAQSection = dynamic(
  () => import("@/app/components/oko-design/sections/sp/FAQSection"),
  { loading: () => null },
);
const SupportCTA = dynamic(
  () => import("@/app/components/oko-design/sections/sp/SupportCTA"),
  { loading: () => null },
);
const ProductGrid = dynamic(
  () => import("@/app/components/oko-design/sections/sp/ProductGrid"),
  { loading: () => null },
);
const RecentViews = dynamic(
  () => import("@/app/components/oko-design/sections/sp/RecentViews"),
  { loading: () => null },
);
...
function SingleProductPage({
  ...
  return (
    ...
    <article
      ...
      className="bg-oko-cream dark:bg-oko-night text-oko-char-soft dark:text-oko-ondark font-inter"
    >
