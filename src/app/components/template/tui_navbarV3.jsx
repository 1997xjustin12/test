...
export default function TuiNavbar({ logo, menu }) {
  ...
  const handleExpandMenu = (menu_item) => {
    console.log("[TEST] menu_item", menu_item);
                  ...
                  {navigation &&
                    navigation.map((i, index) => (
                      ...
                      >
                        ...
                        ${i.url === expandedMenu?.url && i.url !== ParentSlug ? "text-theme-700" : ""}
                        `}
                            >
                              {i.name}
                            </div>
                ...
                >
                  <div className="container mx-auto p-2 flex flex-col gap-[10px]">
                    ...
                    <div className="flex justify-evenly py-[10px]">
                      <div>
                        <div className="aspect-1 bg-neutral-300"></div>
                              ...
                              <div key={`sublink-col-${index}`}>
                                {col.map((sublink) => (
                                  ...
                                  >
                                    ...
                                    className="text-base font-semibold text-neutral-800 hover:underline hover:text-theme-800">{sublink?.name}</Link>
                                    {sublink?.children &&
