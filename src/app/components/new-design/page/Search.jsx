          ...
          >
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <svg className="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-orange-400 transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
...
export default function NewSearchPage({
  ...
  return (
    <PageWrapper>
      ...
      <div className="w-full border-b border-gray-200 dark:border-gray-700 mb-0 sticky top-[64px] lg:top-[105px] bg-white dark:bg-gray-950 z-10 overflow-x-auto">
        <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
          <div className="flex">
            {searchResults.map((t) => (
              ...
              >
                {t.label}{" "}
                <span className={`ml-1 text-xs ${ACTIVE_TAB === t.prop ? "text-orange-500" : "text-gray-400"}`}>
                  ({t.total || 0})
                </span>
              </Link>
            ))}
