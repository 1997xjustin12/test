  ...
  return (
    <div className="max-w-[1240px] mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
        {highlights.map(h => (
          <div key={h.title} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-5 text-center hover:border-orange-600 dark:hover:border-orange-800 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
            If you need any further assistance with your shipping policy or have any other questions, don&apos;t hesitate to reach out to our customer service team at{" "}
            <Link prefetch={false} href={`tel:${contact}`} className="underline text-orange-600 dark:text-orange-400 hover:text-orange-700 transition-colors">
              {contact}
            </Link>
          </p>
        </div>
