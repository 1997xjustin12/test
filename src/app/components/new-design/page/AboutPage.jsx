...
function AboutPage() {
  ...
  const values = [
    {
      icon: "🔥",
      title: "Passion for Fire",
      desc: "We believe every home deserves the warmth and beauty of a world-class fireplace. It's not just a product — it's an experience.",
    },
    {
      icon: "🏆",
      title: "Expert Knowledge",
      desc: "Our team of certified specialists has decades of combined experience across gas, electric, and wood-burning systems.",
    },
    {
      icon: "🤝",
      title: "Customer First",
      desc: "From first click to final install, we're your partner. Found it cheaper? We'll match it. Not satisfied? We'll make it right.",
    },
    {
      icon: "🌿",
      title: "Sustainability",
      desc: "We actively source and promote energy-efficient products and partner with brands committed to reducing environmental impact.",
    },
    {
      icon: "⚡",
      title: "Fast & Reliable",
      desc: "Same-day shipping on in-stock items, white-glove delivery options, and real-time order tracking from warehouse to door.",
    },
    {
      icon: "🛡️",
      title: "Trusted Quality",
      desc: "Every product we carry is vetted by our team. If we wouldn't put it in our own homes, it doesn't make our shelves.",
    },
  ];
  const team = [
    {
    ...
    <div className="max-w-[1240] mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-14 items-center">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
            ...
            , we are focused on providing the best prices on the largest
            selection of fireplaces and outdoor products. We&apos;ve been
            selling fireplaces and accessories for over 20 years and strive to
            become the most trusted source for all home heating needs.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
            Not only do we provide the most complete collection of high-quality
            fireplaces and heating products, but our customer service is the
            best in the business. Our specialists guide customers throughout
            their shopping experience to ensure they get the fireplace that best
            suits their needs — and even after installation, our door is always
            open for questions about features, setup, or making the most of your
            space.
          </p>
      ...
      >
        <div
          ...
          style={{
            background: `radial-gradient(ellipse at 50% 100%, color-mix(in srgb, var(--theme-primary-700), transparent 60%), transparent 60%)`,
          }}
        />
