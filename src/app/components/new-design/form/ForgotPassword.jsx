...
import FormCard from "@/app/components/new-design/form/FormCard.jsx";
...
const buttonClass =
  "w-full py-2.5 bg-theme-600 hover:bg-theme-600 text-white text-sm font-semibold rounded-lg transition-colors disabled:opacity-60 disabled:cursor-not-allowed";
