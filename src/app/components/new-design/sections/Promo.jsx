        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center py-20">
          ...
          <div ref={copyRef} className="opacity-0 translate-y-6 transition-all duration-700">
            ...
            <div className="flex flex-wrap gap-3">
              <a href={PHONE_HREF} className="inline-flex items-center gap-2 px-7 py-3.5 rounded-lg bg-fire hover:bg-fire-light text-white font-semibold transition-all duration-200 hover:-translate-y-0.5">
                Call to Save Now
              </a>
              <a href="#" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-lg border-2 border-white/60 text-white hover:bg-white/10 font-semibold transition-all duration-200">
                Browse All Deals
              </a>
            </div>
          </div>
