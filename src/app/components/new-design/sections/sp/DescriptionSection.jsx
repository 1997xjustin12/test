...
const DescriptionSection = ({ brand, brandDescription, brandHref = "#", description }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-4">
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden">
          <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100 dark:border-gray-800">
            ...
            <h3 className="text-sm font-bold text-gray-900 dark:text-white">Product Description</h3>
          </div>
          <div className="p-5">
        ...
        <div className="bg-gray-900 dark:bg-gray-950 border border-gray-800 rounded-2xl p-5 flex flex-col justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-400 leading-relaxed">{brandDescription}</p>
          </div>
          <Link
            href={brandHref}
