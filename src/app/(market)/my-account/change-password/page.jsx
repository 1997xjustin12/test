  ...
  const handleSubmit = async(e) => {
    ...
    try{
      ...
      if(!response.ok){
        ...
        const error_message = Array.isArray(data?.[error_field]) ? data?.[error_field]?.[0] : data?.[error_field];
      ...
      setNotif({message: "Password successfully updated.", status: "success"});
    }catch(err){
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  ></input>
                  <button className="absolute right-2 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-700" onMouseDown={()=>setViewPass1(true)} onMouseUp={()=>setViewPass1(false)} type="button">
                    {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-theme-500 focus:outline-none relative"
                  ></input>
                  <button className="absolute right-2 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-700" onMouseDown={()=>setViewPass2(true)} onMouseUp={()=>setViewPass2(false)} type="button">
                    {
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-theme-500 focus:outline-none relative"
                  ></input>
                  <button className="absolute right-2 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-700" onMouseDown={()=>setViewPass3(true)} onMouseUp={()=>setViewPass3(false)} type="button">
                    {
