    ...
    <div className="w-full p-5">
      <div className="max-w-[700px] mx-auto mt-10 p-6 bg-white rounded shadow-lg text-gray-800 border border-neutral-200">
        ...
        <p className="mb-4">
          ...
          , we are focused on providing the best prices on the largest selection
          of BBQ grills and outdoor accessories. We’ve been selling barbecue
          grills and accessories for over 20 years and strive to become the most
          trusted source for all outdoor kitchen equipment.
        </p>

        <p className="mb-4">
          Not only do we provide the most complete collection of high-quality
          grills, BBQ smokers, and backyard equipment, but our customer service
          is the best in the business. Our BBQ experts help guide our customers
          throughout their shopping experience to ensure that they get the grill
          that best suits their needs at the best possible price. Our goal is
          for our customers to get the most for their money, no matter what
          their budget is.
        </p>
        ...
        <p>
          ...
          . Our grilling and outdoor living experts are here to answer all of
          your questions, whether they are general or specific to a product. We
