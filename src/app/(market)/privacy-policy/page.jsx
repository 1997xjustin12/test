  ...
  return (
    <div className="w-full p-5">
      <div className="max-w-4xl mx-auto px-10 py-10 text-gray-800 rounded shadow-lg border border-neutral-200">
        ...
        <p>
          {brandName} (“us”, “we”, or “our”) operates
          {brandSite} (hereinafter referred to as “Service”).
        </p>
        <p>
          Our Privacy Policy governs your visit to {brandSite}, and explains how
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>SERVICE</strong> means the {brandSite} website operated by
            BBQ Grill Outlet.
          </li>
          <li>
          ...
          <li>
            <strong>USAGE DATA</strong> is data collected automatically either generated by the use of Service or from the Service infrastructure itself (for example, the duration of a page visit).
          </li>
          <li>
        ...
        <p className="mb-3">When you access Service with a device, this Usage Data may include information such as the type of device you use, your device unique ID, the IP address of your device, your device operating system, the type of Internet browser you use, unique device identifiers and other diagnostic data.</p>

        <h3 className="text-xl font-bold mt-6 mb-2">Location Data</h3>
        <p className="mb-3">
          We may use and store information about your location if you give us permission to do so (“Location Data”). We use this data to provide features of our Service, to improve and customize our Service.
        </p>
        <p className="mb-3">You can enable or disable location services when you use our Service at any time by way of your device settings</p>
        ...
        <p>
          Solana Fireplaces uses the collected data for various purposes:
        </p>
        ...
        <p className="mb-3">
          ...
          Personal Dthe ata, to United States and process it there.
        </p>
        <p className="mb-3">
        ...
        <p>
          BBQ Grill Outlet, will take all the steps reasonably necessary to
        ...
        <ul className="list-decimal pl-6 space-y-2">
          <li>
            <p className="mb-3">Disclosure for Law Enforcement.</p>
            <p>
          ...
          <li>
            <p className="mb-3">Business Transaction.</p>
            <p>
        ...
        <p className="mb-3">
          ...
          <Link prefetch={false} href={`mailto:${email}`}>{email}</Link>
        </p>
        <p className="mb-3">
        ...
        <p className="mb-3">According to CalOPPA we agree to the following:</p>
        <ul className="list-disc pl-6 space-y-2 mb-3">
          ...
          <li>
            ...
            at <Link prefetch={false} href={`mailto:${email}`}>{email}</Link>.
          </li>
        </ul>
        <p className="mb-3">Our Policy on “Do Not Track” Signals:</p>
        <p className="mb-3">
        ...
        <ul className="list-disc pl-6 space-y-2 mb-3">
          <li>
            <p className="mb-3">
              What personal information do we have about you. If you make this
          ...
          <li>
            <p className="mb-3">
              ...
              California law. You are the only owner of your Personal Data and
        ...
        <p className="mb-3">
          ...
          please send your request(s) by email: <Link prefetch={false} href={`mailto:${email}`}>{email}</Link>.
        </p>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">16. Advertising</h2>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">
          17. Behavioral re-marketing
        </h2>
        <p>
          We may use re-marketing services to advertise on third party websites
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">18. Payments</h2>
        <p className="mb-3">
        ...
        <p className="mb-3">
          Our Products are not intended for use by children under the age of 18
          (“Child” or “Children”).
        </p>
        <p>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">22. Contact Us</h2>
        <p>
